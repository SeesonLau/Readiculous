...
{
    public partial class ReadiculousDbContext : DbContext
    {
        public ReadiculousDbContext()
        {
        }

        public ReadiculousDbContext(DbContextOptions<ReadiculousDbContext> options)
            : base(options)
        {
        }
