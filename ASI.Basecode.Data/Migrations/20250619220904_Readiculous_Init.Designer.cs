...
namespace ASI.Basecode.Data.Migrations
{
    ...
    [Migration("20250619220904_Readiculous_Init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASI.Basecode.Data.Models.Book", b =>
                {
                    ...
                    b.HasIndex(new[] { "AverageRating" }, "IX_AverageRating")
                        .HasFilter("[DeletedTime] IS NULL");
            ...
            modelBuilder.Entity("ASI.Basecode.Data.Models.BookGenreAssignment", b =>
                {
                    b.Property<string>("BookId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ASI.Basecode.Data.Models.Book", b =>
                {
                    b.HasOne("ASI.Basecode.Data.Models.Genre", "BookGenre")
                        .WithMany()
                    ...
                    b.HasOne("ASI.Basecode.Data.Models.User", "DeletedByUser")
                        .WithMany()
